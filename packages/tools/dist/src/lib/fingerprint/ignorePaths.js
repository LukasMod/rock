...
function getHarmonyIgnorePaths(sourceDir) {
    return [
        `${sourceDir}/.hvigor`,
        `${sourceDir}/**/.idea`,
...
function getPlatformDirIgnorePaths(platform, sourceDir) {
    if (platform === 'android') {
 ...
 * @returns All ignore paths for the given platform, source directory and project root.
 */
export function getAllIgnorePaths(platform, sourceDir, projectRoot) {
    return [
